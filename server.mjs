...
const ahhhh = await Shift_Assignments.findAll( {where: {DaysAssigned: "Mon AM"}},{attributes: {exclude: ['id', 'Assignments', 'DaysAssigned', 'min_title']}}).then(result => {return result})
