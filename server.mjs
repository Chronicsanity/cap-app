...
const ahhhh = await Shift_Assignments.findOne( {attributes: {exclude: ['id', 'Assignments', 'DaysAssigned', 'min_title', [sequelize.literal('static value')]]}},{where: {DaysAssigned: "Mon AM"}})
